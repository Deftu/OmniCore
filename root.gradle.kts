...
preprocess {
    ...
    fabric12002.link(fabric11904)
    forge11904.link(fabric11904)
    fabric11904.link(fabric11903)
    forge11903.link(fabric11903)
    fabric11903.link(fabric11902, file("versions/1.19.3-fabric+1.19.2-fabric.txt"))
    ...
    fabric11701.link(fabric11605, file("versions/1.17.1-fabric+1.16.5-fabric.txt"))
    fabric11605.link(forge11605)
    forge11605.link(forge11202, file("versions/1.16.5-forge+1.12.2-forge.txt"))
