...
public object MultiKeyboard {
    ...
    //#else
    //$$ @JvmField public val KEY_NONE: Int = noInline { Keyboard.KEY_NONE }
    //$$ @JvmField public val KEY_ESCAPE: Int = noInline { Keyboard.KEY_ESCAPE }
    //$$ @JvmField public val KEY_LMETA: Int = noInline { Keyboard.KEY_LMETA }
    //$$ @JvmField public val KEY_RMETA: Int = noInline { Keyboard.KEY_RMETA }
    //$$ @JvmField public val KEY_LCONTROL: Int = noInline { Keyboard.KEY_LCONTROL }
    //$$ @JvmField public val KEY_RCONTROL: Int = noInline { Keyboard.KEY_RCONTROL }
    //$$ @JvmField public val KEY_LSHIFT: Int = noInline { Keyboard.KEY_LSHIFT }
    //$$ @JvmField public val KEY_RSHIFT: Int = noInline { Keyboard.KEY_RSHIFT }
    //$$ @JvmField public val KEY_LMENU: Int = noInline { Keyboard.KEY_LMENU }
    //$$ @JvmField public val KEY_RMENU: Int = noInline { Keyboard.KEY_RMENU }
    //$$ @JvmField public val KEY_MINUS: Int = noInline { Keyboard.KEY_MINUS }
    //$$ @JvmField public val KEY_EQUALS: Int = noInline { Keyboard.KEY_EQUALS }
    //$$ @JvmField public val KEY_BACKSPACE: Int = noInline { Keyboard.KEY_BACK }
    //$$ @JvmField public val KEY_ENTER: Int = noInline { Keyboard.KEY_RETURN }
    //$$ @JvmField public val KEY_TAB: Int = noInline { Keyboard.KEY_TAB }
    //$$ @JvmField public val KEY_LBRACKET: Int = noInline { Keyboard.KEY_LBRACKET }
    //$$ @JvmField public val KEY_RBRACKET: Int = noInline { Keyboard.KEY_RBRACKET }
    //$$ @JvmField public val KEY_SEMICOLON: Int = noInline { Keyboard.KEY_SEMICOLON }
    //$$ @JvmField public val KEY_APOSTROPHE: Int = noInline { Keyboard.KEY_APOSTROPHE }
    //$$ @JvmField public val KEY_GRAVE: Int = noInline { Keyboard.KEY_GRAVE }
    //$$ @JvmField public val KEY_BACKSLASH: Int = noInline { Keyboard.KEY_BACKSLASH }
    //$$ @JvmField public val KEY_COMMA: Int = noInline { Keyboard.KEY_COMMA }
    //$$ @JvmField public val KEY_PERIOD: Int = noInline { Keyboard.KEY_PERIOD }
    //$$ @JvmField public val KEY_SLASH: Int = noInline { Keyboard.KEY_SLASH }
    //$$ @JvmField public val KEY_MULTIPLY: Int = noInline { Keyboard.KEY_MULTIPLY }
    //$$ @JvmField public val KEY_SPACE: Int = noInline { Keyboard.KEY_SPACE }
    //$$ @JvmField public val KEY_CAPITAL: Int = noInline { Keyboard.KEY_CAPITAL }
    //$$ @JvmField public val KEY_LEFT: Int = noInline { Keyboard.KEY_LEFT }
    //$$ @JvmField public val KEY_UP: Int = noInline { Keyboard.KEY_UP }
    //$$ @JvmField public val KEY_RIGHT: Int = noInline { Keyboard.KEY_RIGHT }
    //$$ @JvmField public val KEY_DOWN: Int = noInline { Keyboard.KEY_DOWN }
    //$$ @JvmField public val KEY_NUMLOCK: Int = noInline { Keyboard.KEY_NUMLOCK }
    //$$ @JvmField public val KEY_SCROLL: Int = noInline { Keyboard.KEY_SCROLL }
    //$$ @JvmField public val KEY_SUBTRACT: Int = noInline { Keyboard.KEY_SUBTRACT }
    //$$ @JvmField public val KEY_ADD: Int = noInline { Keyboard.KEY_ADD }
    //$$ @JvmField public val KEY_DIVIDE: Int = noInline { Keyboard.KEY_DIVIDE }
    //$$ @JvmField public val KEY_DECIMAL: Int = noInline { Keyboard.KEY_DECIMAL }
    //$$ @JvmField public val KEY_NUMPAD0: Int = noInline { Keyboard.KEY_NUMPAD0 }
    //$$ @JvmField public val KEY_NUMPAD1: Int = noInline { Keyboard.KEY_NUMPAD1 }
    //$$ @JvmField public val KEY_NUMPAD2: Int = noInline { Keyboard.KEY_NUMPAD2 }
    //$$ @JvmField public val KEY_NUMPAD3: Int = noInline { Keyboard.KEY_NUMPAD3 }
    //$$ @JvmField public val KEY_NUMPAD4: Int = noInline { Keyboard.KEY_NUMPAD4 }
    //$$ @JvmField public val KEY_NUMPAD5: Int = noInline { Keyboard.KEY_NUMPAD5 }
    //$$ @JvmField public val KEY_NUMPAD6: Int = noInline { Keyboard.KEY_NUMPAD6 }
    //$$ @JvmField public val KEY_NUMPAD7: Int = noInline { Keyboard.KEY_NUMPAD7 }
    //$$ @JvmField public val KEY_NUMPAD8: Int = noInline { Keyboard.KEY_NUMPAD8 }
    //$$ @JvmField public val KEY_NUMPAD9: Int = noInline { Keyboard.KEY_NUMPAD9 }
    //$$ @JvmField public val KEY_A: Int = noInline { Keyboard.KEY_A }
    //$$ @JvmField public val KEY_B: Int = noInline { Keyboard.KEY_B }
    //$$ @JvmField public val KEY_C: Int = noInline { Keyboard.KEY_C }
    //$$ @JvmField public val KEY_D: Int = noInline { Keyboard.KEY_D }
    //$$ @JvmField public val KEY_E: Int = noInline { Keyboard.KEY_E }
    //$$ @JvmField public val KEY_F: Int = noInline { Keyboard.KEY_F }
    //$$ @JvmField public val KEY_G: Int = noInline { Keyboard.KEY_G }
    //$$ @JvmField public val KEY_H: Int = noInline { Keyboard.KEY_H }
    //$$ @JvmField public val KEY_I: Int = noInline { Keyboard.KEY_I }
    //$$ @JvmField public val KEY_J: Int = noInline { Keyboard.KEY_J }
    //$$ @JvmField public val KEY_K: Int = noInline { Keyboard.KEY_K }
    //$$ @JvmField public val KEY_L: Int = noInline { Keyboard.KEY_L }
    //$$ @JvmField public val KEY_M: Int = noInline { Keyboard.KEY_M }
    //$$ @JvmField public val KEY_N: Int = noInline { Keyboard.KEY_N }
    //$$ @JvmField public val KEY_O: Int = noInline { Keyboard.KEY_O }
    //$$ @JvmField public val KEY_P: Int = noInline { Keyboard.KEY_P }
    //$$ @JvmField public val KEY_Q: Int = noInline { Keyboard.KEY_Q }
    //$$ @JvmField public val KEY_R: Int = noInline { Keyboard.KEY_R }
    //$$ @JvmField public val KEY_S: Int = noInline { Keyboard.KEY_S }
    //$$ @JvmField public val KEY_T: Int = noInline { Keyboard.KEY_T }
    //$$ @JvmField public val KEY_U: Int = noInline { Keyboard.KEY_U }
    //$$ @JvmField public val KEY_V: Int = noInline { Keyboard.KEY_V }
    //$$ @JvmField public val KEY_W: Int = noInline { Keyboard.KEY_W }
    //$$ @JvmField public val KEY_X: Int = noInline { Keyboard.KEY_X }
    //$$ @JvmField public val KEY_Y: Int = noInline { Keyboard.KEY_Y }
    //$$ @JvmField public val KEY_Z: Int = noInline { Keyboard.KEY_Z }
    //$$ @JvmField public val KEY_0: Int = noInline { Keyboard.KEY_0 }
    //$$ @JvmField public val KEY_1: Int = noInline { Keyboard.KEY_1 }
    //$$ @JvmField public val KEY_2: Int = noInline { Keyboard.KEY_2 }
    //$$ @JvmField public val KEY_3: Int = noInline { Keyboard.KEY_3 }
    //$$ @JvmField public val KEY_4: Int = noInline { Keyboard.KEY_4 }
    //$$ @JvmField public val KEY_5: Int = noInline { Keyboard.KEY_5 }
    //$$ @JvmField public val KEY_6: Int = noInline { Keyboard.KEY_6 }
    //$$ @JvmField public val KEY_7: Int = noInline { Keyboard.KEY_7 }
    //$$ @JvmField public val KEY_8: Int = noInline { Keyboard.KEY_8 }
    //$$ @JvmField public val KEY_9: Int = noInline { Keyboard.KEY_9 }
    //$$ @JvmField public val KEY_F1: Int = noInline { Keyboard.KEY_F1 }
    //$$ @JvmField public val KEY_F2: Int = noInline { Keyboard.KEY_F2 }
    //$$ @JvmField public val KEY_F3: Int = noInline { Keyboard.KEY_F3 }
    //$$ @JvmField public val KEY_F4: Int = noInline { Keyboard.KEY_F4 }
    //$$ @JvmField public val KEY_F5: Int = noInline { Keyboard.KEY_F5 }
    //$$ @JvmField public val KEY_F6: Int = noInline { Keyboard.KEY_F6 }
    //$$ @JvmField public val KEY_F7: Int = noInline { Keyboard.KEY_F7 }
    //$$ @JvmField public val KEY_F8: Int = noInline { Keyboard.KEY_F8 }
    //$$ @JvmField public val KEY_F9: Int = noInline { Keyboard.KEY_F9 }
    //$$ @JvmField public val KEY_F10: Int = noInline { Keyboard.KEY_F10 }
    //$$ @JvmField public val KEY_F11: Int = noInline { Keyboard.KEY_F11 }
    //$$ @JvmField public val KEY_F12: Int = noInline { Keyboard.KEY_F12 }
    //$$ @JvmField public val KEY_F13: Int = noInline { Keyboard.KEY_F13 }
    //$$ @JvmField public val KEY_F14: Int = noInline { Keyboard.KEY_F14 }
    //$$ @JvmField public val KEY_F15: Int = noInline { Keyboard.KEY_F15 }
    //$$ @JvmField public val KEY_F16: Int = noInline { Keyboard.KEY_F16 }
    //$$ @JvmField public val KEY_F17: Int = noInline { Keyboard.KEY_F17 }
    //$$ @JvmField public val KEY_F18: Int = noInline { Keyboard.KEY_F18 }
    //$$ @JvmField public val KEY_F19: Int = noInline { Keyboard.KEY_F19 }
    //$$ @JvmField public val KEY_DELETE: Int = noInline { Keyboard.KEY_DELETE }
    //$$ @JvmField public val KEY_HOME: Int = noInline { Keyboard.KEY_HOME }
    //$$ @JvmField public val KEY_END: Int = noInline { Keyboard.KEY_END }
    //#endif
