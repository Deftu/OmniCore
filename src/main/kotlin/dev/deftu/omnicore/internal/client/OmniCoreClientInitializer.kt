        ...
        OmniClientCommands.command("omnicore") {
            ...
            then("mau5") {
                runs { ctx ->
                    ...
                    lyrics.add(Text.literal("I like the sound of the broken pieces").setStyle(MCTextStyle.color(TextColors.DARK_PURPLE)))
                    lyrics.add(Text.literal("I like the lights and the siren, she says").setStyle(MCTextStyle.color(TextColors.LIGHT_PURPLE)))
                    lyrics.add(Text.literal("We got machines but the kids got Jesus").setStyle(MCTextStyle.color(TextColors.LIGHT_PURPLE)))
                    lyrics.add(Text.literal("We like to move like we both don't need this").setStyle(MCTextStyle.color(TextColors.DARK_PURPLE)))
                    lyrics.add(Text.literal("God can't hear you").setStyle(MCTextStyle.color(TextColors.GRAY).italic()))
                    lyrics.add(Text.literal("They won't fight you").setStyle(MCTextStyle.color(TextColors.GRAY).italic()))
                    lyrics.add(Text.literal("Watch them build a friend just like you").setStyle(MCTextStyle.color(TextColors.GRAY).italic()))
                    lyrics.add(Text.literal("Morning sickness, XYZ").setStyle(MCTextStyle.color(TextColors.DARK_PURPLE)))
                    lyrics.add(Text.literal("Teenage girls with ESP").setStyle(MCTextStyle.color(TextColors.LIGHT_PURPLE)))
                    lyrics.add(Text.literal("Give me the sound to see").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
                    lyrics.add(Text.literal("Another world outside that's full of").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
                    lyrics.add(Text.literal("All the broken things that I made").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
                    lyrics.add(Text.literal("Just give me a life to bleed").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
                    lyrics.add(Text.literal("Another world outside that's full of").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
                    lyrics.add(Text.literal("All the awful things that I made").setStyle(MCTextStyle.color(TextColors.GOLD).bold().italic()))
